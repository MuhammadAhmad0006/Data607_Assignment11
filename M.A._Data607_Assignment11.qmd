...
### Conclusions 
  ...
  Using the recommender lab package I was able to make a Userbased content filter to
recommend the type of movies each critic would want to watch based off of their ratings. I used cross validation to split the data into testing and training. Using accuracy metrics to test whether the model is accurate and found that it usually is off by one star. I then ran the model for each critic to recommend movies they have not watched. 
